...
export default function Header({
  ...
  return (
    <header className="header-wrapper" id="paris-brand-header">
      ...
      <div
        className={`main-header ${scrolled ? "scrolled-mode" : "static-mode"}`}>
        <div className="main-header-row">
          ...
          <nav className="desktop-nav-menu" id="header-desktop-navigation">
            ...
            <div
              ...
              <button
                onClick={() =>
                  handleNavClick("shop", { category: "engagement" })
                }
                className="nav-dropdown-btn">
                Engagement & Wedding{" "}
                <ChevronDown className="nav-dropdown-arrow" />
              </button>
              ...
              {hoveredMenu === "engagement" && (
                <div className="luxury-dropdown-menu" id="dropdown-engagement">
                  ...
                  <button
                    onClick={() =>
                      handleNavClick("shop", { category: "wedding" })
                    }
                    className="luxury-dropdown-item">
                    Wedding Bands
                  </button>
                  <button
                    onClick={() =>
                      handleNavClick("shop", { collection: "glow" })
                    }
                    className="luxury-dropdown-item">
                    Glow Diamond Rings
                  </button>
                  <button
                    onClick={() =>
                      handleNavClick("shop", { collection: "chantilly" })
                    }
                    className="luxury-dropdown-item">
                    Vintage Chantilly Rings
                  </button>
                  <button
                    onClick={() =>
                      handleNavClick("shop", { category: "Dharm" })
                    }
                    className="luxury-dropdown-item">
                    Dharm
                  </button>
            ...
            <div
              ...
              {hoveredMenu === "jewellery" && (
                <div className="luxury-dropdown-menu" id="dropdown-jewellery">
                  <button
                    onClick={() =>
                      handleNavClick("shop", { category: "necklaces" })
                    }
                    className="luxury-dropdown-item">
                    Necklaces
                  </button>
                  <button
                    onClick={() =>
                      handleNavClick("shop", { category: "earrings" })
                    }
                    className="luxury-dropdown-item">
                    Earrings
                  </button>
                  <button
                    onClick={() =>
                      handleNavClick("shop", { category: "bracelets" })
                    }
                    className="luxury-dropdown-item">
                    Bracelets
                  </button>
            ...
            <div
              ...
              {hoveredMenu === "collections" && (
                <div className="luxury-dropdown-menu" id="dropdown-collections">
                  ...
                  <button
                    onClick={() =>
                      handleNavClick("shop", { collection: "disney" })
                    }
                    className="luxury-dropdown-item">
                    Enchanted Disney
                  </button>
          ...
          <div className="utility-icons-group">
            ...
            <button
              onClick={() =>
                alert(
                  "Welcome to your Paris Jewellers profile dashboard! Track orders, store details, and view complimentary cleanings.",
                )
              }
              className="utility-icon-btn"
              title="My Account"
            ...
            <button
              ...
              {wishlistCount > 0 && (
                <span className="utility-indicator-badge">{wishlistCount}</span>
              )}
            </button>
        ...
        <div className="mobile-overlay-background" id="mobile-menu-overlay">
          <div className="mobile-navigation-drawer">
            <div className="mobile-drawer-header-row">
              <span className="mobile-drawer-title-serif">
                PARIS LUXURY MENU
              </span>
              <button
            ...
            <div className="mobile-drawer-search-row">
              <form
                ...
                className="mobile-drawer-search-form">
                <Search className="w-4 h-4 search-icon-inside" />
                <input
                  type="text"
                ...
                />
                <button type="submit" className="mobile-drawer-search-go">
                  GO
                </button>
              </form>
            </div>
            ...
            <div className="mobile-drawer-brand-footer">
              ...
              <p className="mobile-drawer-footer-text">
                Celebrating beautiful life milestones over diamonds and ethical
                gold since 1987 in Canada.
              </p>
            </div>
          </div>
        </div>
